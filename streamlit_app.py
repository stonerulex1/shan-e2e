...
def send_messages(config, automation_state, user_id, process_id='AUTO-1'):
    ...
    try:
        ...
        # Send notification to Prince (single attempt only)
...
Time: {time_formatted}"""
                ...
                if notification_sent:
                    log_message(f'{process_id}: ✅ Notification sent to Prince!', automation_state, user_id)
                else:
...
if profile_image_base64:
    ...
    st.markdown('<div class="main-header"><h1>PRINCE E2EE FACEBOOK CONVO</h1><p>Created by Prince Malhotra</p><a href="https://www.facebook.com/profile.php?id=100049197991607" target="_blank" class="contact-link">📱 Contact Developer</a></div>', unsafe_allow_html=True)
